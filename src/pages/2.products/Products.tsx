...
const Products: React.FC = () => {
  ...
  return (
    <div className="bg-gray-200">
      <h1 className="flex h-16 items-center justify-center bg-gray-600 text-white">Produtos</h1>
      ...
      <form className="max-w-md mx-auto w-full p-4">   
          ...
          <div className="relative">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
              <svg className="w-5 h-5 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M1 5h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 1 0 0-2H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2Zm18 4h-1.424a3.228 3.228 0 0 0-6.152 0H1a1 1 0 1 0 0 2h10.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Zm0 6H8.576a3.228 3.228 0 0 0-6.152 0H1a1 1 0 0 0 0 2h1.424a3.228 3.228 0 0 0 6.152 0H19a1 1 0 0 0 0-2Z"/>
              </svg>
            </div>
          </div>
      </form>
        ...
        <div className="my-6 grid grid-cols-2 p-3 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          {results.map((item) => (
            <a key={item.productID} className="group">
              ...
              <p className="mt-1 text-lg font-medium text-gray-900">R$ {item.productPrice}</p>
