...
const Home: React.FC = () => {
  return (
    <div className='bg-gray-200'>
      ...
      <h1 className="fixed top-0 left-0 right-0 flex h-16 items-center justify-center bg-white text-black font-bold w-full" style={{ fontSize: 18, zIndex: 10, boxShadow: '0px 2px 4px rgba(0, 0, 0, 0.1)' }}>HOME</h1>

      <div className="flex flex-col items-center p-5 mt-16">
